...
export const fetchAdminProducts= createAsyncThunk("admin/products/fetchProducts",async()=>{
...
const adminProductSlice = createSlice({
    ...
    extraReducers: (builder)=>{
        ...
        //update Product
        .addCase(updateProduct.fulfilled, (state,action)=>{     const index= state.products.findIndex((product)=>product._id ===action.payload._id);
