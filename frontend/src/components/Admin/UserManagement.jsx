...
import { addUser, deleteUser, updatedUser, fetchUsers } from '../../redux/slices/adminSlice';
...
if(error) return <p>Error:{error}</p>;
  return (
    <div className='ma-w-7xll mx-auto p-6'>
            ...
            <table className="min-w-full text-left text-gray-500">
                <thead className='bg-gray-100 text-xs uppercase text-gray-700'>
                    <tr>
                        ...
                        <th className='py-3 px-4'>Actiions</th>
                    </tr>
                </thead>
                <tbody>
                    {users.map((user)=>(
                        <tr key={user._id} className='border-b hover:bg-gray-50'>
                             <td className='p-4 font-medium textt-gray-900 whitespace-nowrap'>{user.name}</td>
