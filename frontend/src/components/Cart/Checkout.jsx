...
if(!cart ||!cart.products||cart.products.length===0){
  ...
  return (
        ...
        <form onSubmit={handleCreateCheckout}>
            ...
            <div className='mb-4 grid grid-cols-2 gap-4 '>
                <div>
                    ...
                    onChange={(e)=> setShippingAdress({...shippingAddress,firstName:e.target.value,})}className='w-full p-2 border rounded ' required/>
                </div>
                 <div>
                    <label className='block text-gray-700'>Last Name</label>
                    <input type="text"
                    value={shippingAddress.lastName} 
                    onChange={(e)=> setShippingAdress({...shippingAddress,lastName:e.target.value,})}className='w-full p-2 border rounded ' required/>
                </div>
            </div>
            <div className="mb-4">
            ...
            <div className='mb-4 grid grid-cols-2 gap-4 '>
                 <div>
                    ...
                    onChange={(e)=> setShippingAdress({...shippingAddress,city:e.target.value,})}className='w-full p-2 border rounded ' required/>
                </div>
                 <div>
                    <label className='block text-gray-700'>Postal Code</label>
                    <input type="text"
                    value={shippingAddress.postalCode} 
                    onChange={(e)=> setShippingAdress({...shippingAddress,postalCode:e.target.value,})}className='w-full p-2 border rounded ' required/>
                </div>
            </div>
            <div className="mb-4">
    ...
    <div className='bg-gray-50 p-6 rounded-lg '>
        ...
        <div className='flex justify-between tems-center text-lg mb-4'>
            <p>Subtotal</p>
