...
router.post("/", async(req,res)=>{
    ...
    try{
        ...
        //Determine user is logged in or a guest
        let cart=await getCart(userId,guestId);
        
        // If the cart exist we need to updat eit
        ...
        if(cart){
            ...
            //create  a new cart for the guest or users
...
//@route PUT /api/cart
//@desc Update Product quantity in the cart for the guest and a logged in user
//@acess Public
...
//@desc Remove product from cartt
//@acess Public
...
//@route GET /api/cart
//@desc Get logged in usr's and guest's cart
//@acess Public
...
router.post("/merge",protect, async(req,res)=>{
    ...
    try{
        ...
        const userCart = await Cart.findOne({user:req.user._d});
